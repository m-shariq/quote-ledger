...
function generateTableRow(
  ...
  doc
    ...
    .text(date, 20, y)
    .text(item + ac, 60, y)
    .text(batch, 190, y, { width: 100, align: "right" })
    .text(expiry, 250, y, { width: 100, align: "right" })
    .text(quantity, 300, y, { width: 100, align: "right" })
    .text(price, 360, y, { width: 100, align: "right" })
    .text(discount, 400, y, { width: 100, align: "right" })
    .text(total, 465, y, { width: 100, align: "right" })

    .font("Helvetica-Bold")
    .text(remarks, 80, y + 10);
  // .text(lineTotal, 0, y, { align: "right" });
}

function generateHr(doc, y) {
  doc.strokeColor("#aaaaaa").lineWidth(1).moveTo(10, y).lineTo(580, y).stroke();
}
